...
export default function HowToBuy() {
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden px-6 border-y border-foreground/5">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-foreground/70 max-w-2xl mx-auto font-medium">Un proceso simple, rápido y 100% seguro.</p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:items-stretch gap-10 max-w-5xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
              <div className="w-20 h-20 mx-auto bg-gradient-to-br from-gold-500 to-gold-600 rounded-2xl rotate-3 mb-8 flex items-center justify-center shadow-lg shadow-gold-500/30">
                <div className="absolute inset-0 bg-gold-600/30 rounded-2xl -rotate-6 -z-10 blur-sm"></div>
                {step.icon}
              </div>
